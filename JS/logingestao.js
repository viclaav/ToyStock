// Login dos funcionários de gestão
document.addEventListener('DOMContentLoaded', function() {
    ...
    loginForm.addEventListener('submit', function(e) {
        ...
        // Consulta no Firebase - MUDOU AQUI: agora busca em FuncionariosGestao
        database.ref('FuncionariosGestao').once('value')
            .then(snapshot => {
                ...
                if (funcionarioEncontrado) {
                    // Login bem-sucedido
                    mensagemDiv.innerText = "Login de gestão realizado com sucesso! Redirecionando...";
