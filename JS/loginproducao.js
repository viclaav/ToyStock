// Login dos funcionários de produção
document.addEventListener('DOMContentLoaded', function() {
    ...
    loginForm.addEventListener('submit', function(e) {
        ...
        database.ref('FuncionariosProducao').once('value')
            .then(snapshot => {
                ...
                if (funcionarioEncontrado) {
                    ...
                    mensagemDiv.innerText = "Login de produção realizado com sucesso! Redirecionando...";
